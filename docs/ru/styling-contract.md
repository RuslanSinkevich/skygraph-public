# SkyGraph — Контракт стилизации

> English version: [styling-contract.md](../styling-contract.md)
...
- `prefixCls` через `ConfigProvider` — **не входит** в публичный API. Для изоляции классов используйте изолированный скоуп на хосте (shadow DOM или отдельный контейнер со своими токенами).
