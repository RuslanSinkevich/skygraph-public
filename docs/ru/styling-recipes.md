# SkyGraph — Рецепты стилизации

> English version: [styling-recipes.md](../styling-recipes.md)
...
[`styling-contract.md`](./styling-contract.md) §3.1.
...
Полный список слотов — в [`styling-contract.md`](./styling-contract.md) §4.
...
Опираться можно только на то, что заявлено в [`styling-contract.md`](./styling-contract.md):
